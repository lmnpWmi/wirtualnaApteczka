...
public class MedicineListActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK && data != null) {
            if (requestCode == AppConstants.REQUEST_VOICE_INPUT_MEDICINE_NAME && searchMedicineDialogHelper != null) {
                VoiceRecognitionUtils.updateRetrievedNameInSearchDialog(searchMedicineDialogHelper, data);
            }
        }
    ...
    private void initializeFirebaseListeners() {
        ...
        defaultSortComparatorRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                updateMedicineListView(sortedMedicines, defaultSortingComparator);
            }
        ...
        sessionSearchValueRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (!TextUtils.isEmpty(searchValue)) {
                    ...
                    UserPreferences userPreferences = SessionManager.getUserPreferences();
                    SortingComparatorTypeEnum defaultSortingComparatorEnum = userPreferences.getDefaultSortingComparatorEnum();

                    updateMedicineListView(filteredMedicines, defaultSortingComparatorEnum);
                }
            }
    ...
    private void initializeUserMedicineListeners(String currentUserId, FirebaseDatabase database) {
        ...
        userRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (!TextUtils.isEmpty(searchValue)) {
                    currentUserMedicines = MedicineFilter.filterMedicines(searchValue, currentUserMedicines, false);
                }

                updateMedicineListView(currentUserMedicines, defaultSortingComparatorEnum);
            }
    ...
    private void updateMedicineListView(List<Medicine> medicines, SortingComparatorTypeEnum defaultSortingComparatorEnum) {
